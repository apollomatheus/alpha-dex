    ...
    <div class="login-page">
        ...
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <button class="button-positive" @click="register()"> Register </button>
                <button class="button-positive-strong" @click="changePage('login')"> Back to Login </button>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        register() {
            this.$store.commit('TryRegister', { password: this.stored.password, callback: (reply) => {
                if (reply.code == 200) {
